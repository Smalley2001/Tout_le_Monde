...
public class SignedUpEventDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_signed_up_event_details);


        btnCancelSignUp = findViewById(R.id.signed_details_signup_cancel);
        EventName = findViewById(R.id.signed_details_event_name);
        EventHost = findViewById(R.id.signed_details_event_host);
        EventLocation = findViewById(R.id.signed_details_event_location);
        EventDescription = findViewById(R.id.signed_details_event_description);
        EventCampaign = findViewById(R.id.signed_details_event_campaign);
        EventStart = findViewById(R.id.signed_details_event_start);
        EventEnd = findViewById(R.id.signed_details_event_end);
